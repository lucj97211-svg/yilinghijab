...
const FORMSPREE_ID = 'xqabkgqb'; // peri@wennuanfactory.com
    ...
    <form onSubmit={handleSubmit} className="bg-white rounded-xl p-8 border border-[#DDE0E5] shadow-sm" data-component="contact-form">
      ...
      {error && (
        <p className="mb-4 text-sm" style={{ color: '#c0392b' }}>
          ...
          <a href="https://wa.me/8615088248404?text=Hi%2C%20I%27m%20interested%20in%20your%20custom%20hijab%20manufacturing." style={{ textDecoration: 'underline' }}>WhatsApp us</a>{' '}
          or email <a href="mailto:peri@wennuanfactory.com" style={{ textDecoration: 'underline' }}>peri@wennuanfactory.com</a>.
        </p>
      )}
      <div className="flex flex-col gap-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" name="name" required className="w-full px-4 py-2.5 border border-[#DDE0E5] rounded-lg text-sm focus:outline-none focus:border-[#C8962E] focus:ring-2 focus:ring-[rgba(200,150,46,0.2)]" placeholder="Your name" />
          </div>
          <div>
            <label className="block text-sm font-medium text-[#1A1A2E] mb-1.5">Email *</label>
            <input type="email" name="email" required className="w-full px-4 py-2.5 border border-[#DDE0E5] rounded-lg text-sm focus:outline-none focus:border-[#C8962E] focus:ring-2 focus:ring-[rgba(200,150,46,0.2)]" placeholder="you@company.com" />
          </div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-[#1A1A2E] mb-1.5">Company</label>
            <input type="text" name="company" className="w-full px-4 py-2.5 border border-[#DDE0E5] rounded-lg text-sm focus:outline-none focus:border-[#C8962E] focus:ring-2 focus:ring-[rgba(200,150,46,0.2)]" placeholder="Your company" />
          </div>
          <div>
            <label className="block text-sm font-medium text-[#1A1A2E] mb-1.5">Phone / WhatsApp</label>
            <input type="text" name="phone" className="w-full px-4 py-2.5 border border-[#DDE0E5] rounded-lg text-sm focus:outline-none focus:border-[#C8962E] focus:ring-2 focus:ring-[rgba(200,150,46,0.2)]" placeholder="+1 234 567 890" />
          </div>
        </div>
        <div>
          <label className="block text-sm font-medium text-[#1A1A2E] mb-1.5">Product Interest</label>
          <select name="product" className="w-full px-4 py-2.5 border border-[#DDE0E5] rounded-lg text-sm focus:outline-none focus:border-[#C8962E] focus:ring-2 focus:ring-[rgba(200,150,46,0.2)] bg-white">
        ...
        <div>
          ...
          <textarea name="message" required rows={4} className="w-full px-4 py-2.5 border border-[#DDE0E5] rounded-lg text-sm focus:outline-none focus:border-[#C8962E] focus:ring-2 focus:ring-[rgba(200,150,46,0.2)] resize-none" placeholder="Tell us about your requirements..." />
        </div>
